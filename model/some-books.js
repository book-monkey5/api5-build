...
const book_factory_1 = require("./book-factory");
class SomeBooks {
    static getPublic() {
        return SomeBooks.publicBooks.map(b => (Object.assign(Object.assign({}, b), { published: book_factory_1.BookFactory.normalizeDate(b.published), secure: false })));
    }
    static getSecure() {
        return SomeBooks.secureBooks.map(b => (Object.assign(Object.assign({}, b), { published: book_factory_1.BookFactory.normalizeDate(b.published), secure: true })));
    }
    static getAll() {
